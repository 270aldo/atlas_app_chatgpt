...
export const atlasDashboardResource = {
  ...
  handler: async () => {
    const assets = resolveWidgetAssets('atlas-dashboard');
...
<body>
  <div id="root"></div>
  <script type="module" src="${BASE_URL}/src/entrypoints/atlas-dashboard.tsx"></script>
</body>
</html>`;

    return {
      contents: [
        { uri: 'atlas://dashboard/widget', mimeType: 'text/html+skybridge', text: htmlContent },
      ],
    };
  },
};
